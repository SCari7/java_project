...
//// нам понадобится компаратор при добавлении и сортировке
//
////сортировка по фото и альбом айди
//    //Comparator sorted by AlbumId then by PhotoId
...
//      photos[2] = new Photo(1,3,"t3","url3", now.minusDays(8));
//      photos[3] = new Photo(2,1,"t4","url4", now.minusDays(3));
//      photos[4] = new Photo(2,2,"t5","url5", now.minusDays(2));
//      photos[5] = new Photo(1,4,"t5","url5", now.minusDays(7));
//
...
//        Photo[] actual = album.getPhotoBetweenDate(localDate.minusDays(2),
//                localDate.minusDays(6));
//        Arrays.sort(actual,comparator);
//        Photo [] expected = {photos[3], photos[4], photos[2]};
//
