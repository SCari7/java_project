package homework_40.supermarket_linked_list.test;

import homework_40.supermarket_linked_list.dao.Supermarket;
import homework_40.supermarket_linked_list.dao.SupermarketImpl;
...
//            i++;
//        }
        Iterable<Product> actual =  supermarket.findByCategory("Bread"); // безопасный кастинг
