...
public abstract class Employee {
    ...
    public static void setMinWage(double minWage) {
        if (Employee.minWage > Employee.minWage){
            Employee.minWage = Employee.minWage;//устанавливаем ручками
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Employee employee)) return false; // only ID
    ...
    public String toString() {
        ...
        sb.append('}');sb.append(", salary=").append(calcSalary()); // добавил зарплату в распечатку
        return sb.toString();
    }
    //methods for salary
