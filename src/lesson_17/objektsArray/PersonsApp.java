package lesson_17.objektsArray;

public class PersonsApp {
    public static void main(String[] args) {
        Person garry = new Person("Garry", 11,"Photo");
        System.out.println(garry.toString());
        Person john = new Person("John", 75, "Reading");
        ...
        peoples[0] = garry;
        peoples[1] = john;
        peoples[2] = new Person("Tom",4, "crying");

        System.out.println("==========\n");
        System.out.println(peoples[0].toString());
        System.out.println("peoples[], getName(): " + peoples[0].getName());
        ...
        System.out.println("==========\n");
        Person test = new Person("Test", 6, "Runing");
        peoples[2] = test;
